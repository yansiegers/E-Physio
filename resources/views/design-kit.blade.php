@section('title', 'Design Kit')
    ...
    <x-test-layout>
        ...
        <x-forms.label for="text" value="text" />
        <x-forms.input id="text" type="text" placeholder="text" />
        <x-forms.label for="checkbox" value="checkbox" />
        <x-forms.input id="checkbox" type="checkbox" />
        <x-forms.label for="radio" value="radio" />
        <x-forms.input id="radio" type="radio" />

        <x-forms.label for="date" value="date" />
        <x-forms.input id="date" type="date" />
        <x-forms.label for="time" value="time" />
        <x-forms.input id="time" type="time" />
        <x-forms.label for="week" value="week" />
        <x-forms.input id="week" type="week" />
        <x-forms.label for="month" value="month" />
        <x-forms.input id="month" type="month" />
        <x-forms.label for="datetime" value="datetime" />
        ...
        <x-forms.label for="number" value="number" />
        <x-forms.input id="number" type="number" placeholder="1234" />
        <x-forms.label for="password" value="password" />
        <x-forms.input id="password" type="password" placeholder="password" />
        <x-forms.label for="search" value="search" />
        <x-forms.input id="search" type="search" placeholder="search" />
        <x-forms.label for="tel" value="tel" />
        <x-forms.input id="tel" type="tel" placeholder="+31 0612345678" />
        <x-forms.label for="url" value="url" />
        <x-forms.input id="url" type="url" placeholder="https://example.com/" />

        <x-forms.label for="file" value="file" />
